...
import com.dev.buivanphuc.appfoody.Controller.DanDuongToiQuanAnController;
...
public class DanDuongToiQuanAnActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        duongdan = "https://maps.googleapis.com/maps/api/directions/json?origin=" + vitrihientai.getLatitude() + "," + vitrihientai.getLongitude() + "&destination=" +latitude+"," + longitude + "&language=vi&key=AIzaSyCFwQn0HiA0XrN8NPXXobvVZgkbfJgcmYQ";
